...
# 삼성 데이터 
filename = '/content/drive/MyDrive/삼성전자.csv'
filename2 = '/content/drive/MyDrive/삼성전자2.csv'
filename3 = '/content/drive/MyDrive/삼성전자3.csv'
...
np.save('/content/drive/My Drive/samsung_data.npy', arr=total_data)


# 코덱스 데이터
kodex_data = pd.read_csv('/content/drive/MyDrive/kodex.csv', index_col=0,header=0,encoding='CP949')
...
np.save('/content/drive/My Drive/kodex_data.npy', arr=total_kodex_data)
...
hist = model.fit([x_train,kodex_train], y_train, epochs=500,  validation_split=0.3, verbose=1, batch_size=4 ,callbacks=[early_stopping, cp])
